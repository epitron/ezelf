...
document.write('<span> &#8226; </span><a href="http://digg.com/submit?phase=2&partner=fb&url=http%3A%2F%2Fwww.jasonbartholme.com%2F2007%2F06%2F09%2Ftips-for-successful-article-marketing%2F&title=Tips+For+Successful+Article+Marketing">Digg This!</a>');
document.write('<span> &#8226; </span><a href="http://del.icio.us/post?v=4&partner=fb&url=http%3A%2F%2Fwww.jasonbartholme.com%2F2007%2F06%2F09%2Ftips-for-successful-article-marketing%2F&title=Tips+For+Successful+Article+Marketing">Save to del.icio.us</a>');
document.write('</p>');
var fStartPost=1;if(window.feedburner_currPost!=null){window.feedburner_currPost++}else{window.feedburner_currPost=1}if(document.body.getAttribute("fStartPost")){fs=parseInt(document.body.getAttribute("fStartPost"));if(!isNaN(fs))fStartPost=fs}if(window.feedburner_startPostOverride!=null){fs=parseInt(window.feedburner_startPostOverride);if(!isNaN(fs))fStartPost=window.feedburner_startPostOverride}else{window.feedburner_startPostOverride=fStartPost}if(window.feedburner_currPost==fStartPost){feedSrc='http://feeds.feedburner.com/~s/JasonBartholme?i='+escape("http://www.jasonbartholme.com/2007/06/09/tips-for-successful-article-marketing/")+'&showad=true';document.write('<script src=\"'+feedSrc+'\" type=\"text/javascript\"></script>')}
