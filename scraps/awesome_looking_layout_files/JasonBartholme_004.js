...
document.write('<span> &#8226; </span><a href="http://digg.com/submit?phase=2&partner=fb&url=http%3A%2F%2Fwww.jasonbartholme.com%2F2007%2F07%2F12%2Fsearch-engine-marketers-have-a-new-home-at-sphinncom%2F&title=Search+Engine+Marketers+Have+a+New+Home+at+Sphinn.com">Digg This!</a>');
document.write('<span> &#8226; </span><a href="http://del.icio.us/post?v=4&partner=fb&url=http%3A%2F%2Fwww.jasonbartholme.com%2F2007%2F07%2F12%2Fsearch-engine-marketers-have-a-new-home-at-sphinncom%2F&title=Search+Engine+Marketers+Have+a+New+Home+at+Sphinn.com">Save to del.icio.us</a>');
document.write('</p>');
var fStartPost=1;if(window.feedburner_currPost!=null){window.feedburner_currPost++}else{window.feedburner_currPost=1}if(document.body.getAttribute("fStartPost")){fs=parseInt(document.body.getAttribute("fStartPost"));if(!isNaN(fs))fStartPost=fs}if(window.feedburner_startPostOverride!=null){fs=parseInt(window.feedburner_startPostOverride);if(!isNaN(fs))fStartPost=window.feedburner_startPostOverride}else{window.feedburner_startPostOverride=fStartPost}if(window.feedburner_currPost==fStartPost){feedSrc='http://feeds.feedburner.com/~s/JasonBartholme?i='+escape("http://www.jasonbartholme.com/2007/07/12/search-engine-marketers-have-a-new-home-at-sphinncom/")+'&showad=true';document.write('<script src=\"'+feedSrc+'\" type=\"text/javascript\"></script>')}
